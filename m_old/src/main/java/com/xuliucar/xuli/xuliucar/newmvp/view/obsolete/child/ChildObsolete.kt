package com.xuliucar.xuli.xuliucar.newmvp.view.obsolete.child
...
import com.xuliucar.xuli.xuliucar.newmvp.presenter.obsolete.child.ObsoleteTrusteeshipPresenter
import kotlinx.android.synthetic.main.matter_layout.*

class ChildObsolete : BaseNewFragment<ObsoleteItemContract.TrusteeshipPresenter>(), View.OnClickListener, OnItemClick, ObsoleteItemContract.TrusteeshipView {
    ...
    override fun initView(savedInstanceState: Bundle?, view: View) {
        toolbar_view = initToolbar(getString(R.string.Escrow_expired), null, R.drawable.qunfa)
        ...
        ObsoleteTrusteeshipPresenter(this)
        p.start()
