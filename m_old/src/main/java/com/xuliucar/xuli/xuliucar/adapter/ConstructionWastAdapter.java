 ...
 * email
 */
public class ConstructionWastAdapter extends BaseAdapter {
    ...
    public ConstructionWastAdapter(Context context, List<ConstructionWasteBean.DataBean.InfoBean> eProtectBeanList) {
    ...
    public ConstructionWastAdapter(Context context, List<ConstructionWasteBean.DataBean.InfoBean> eProtectBeanList, int isdisplay) {
        this.context = context;
        this.eProtectBeanList = eProtectBeanList;
    ...
    public ConstructionWastAdapter(Context context, List<ConstructionWasteBean.DataBean.InfoBean> eProtectBeanList, int isdisplay, OnSelectedItemChanged listener) {
        this.context = context;
        this.eProtectBeanList = eProtectBeanList;
        this.isdisplay = isdisplay;
        map = new HashMap<>();
            ...
            hb_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (rphone.equals("") && rphone2.equals("")) {
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "临期", StringConfig.ODT_CWASTE + StringConfig.COMPANYNAME, StringConfig.TYPE_CWASTE, rphone, rphone2);
                    }
                }
            });
            ...
            hb_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(phone.equals("null") || phone.equals("")){
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "临期", StringConfig.ODT_CWASTE + StringConfig.COMPANYNAME, StringConfig.TYPE_CWASTE, phone, phone2);
                    }
                }
            });
