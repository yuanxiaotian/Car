 ...
 * email
 */
public class ConstructionWastAdapterO extends BaseAdapter {
    private final Context context;
    private List<ConstructionWasteBean.DataBean.InfoBean> eProtectBeanList;
    ...
    public ConstructionWastAdapterO(Context context, List<ConstructionWasteBean.DataBean.InfoBean> eProtectBeanList) {
    ...
    public ConstructionWastAdapterO(Context context, List<ConstructionWasteBean.DataBean.InfoBean> eProtectBeanList, int isdisplay) {
        this.context = context;
        this.eProtectBeanList = eProtectBeanList;
    ...
    public ConstructionWastAdapterO(Context context, List<ConstructionWasteBean.DataBean.InfoBean> eProtectBeanList, int isdisplay, OnSelectedItemChanged listener) {
        this.context = context;
        this.eProtectBeanList = eProtectBeanList;
        this.isdisplay = isdisplay;
        map = new HashMap<>();
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if (isdisplay == 0) {
            final ConstructionWasteBean.DataBean.InfoBean eProtectBean = eProtectBeanList.get(i);
            ...
            hb_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (rphone.equals("") && rphone2.equals("")) {
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "过期", StringConfig.OD_CWASTE + StringConfig.COMPANYNAME, StringConfig.TYPE_CWASTE, rphone, rphone2);
                    }
                }
            });
            ...
            final ConstructionWasteBean.DataBean.InfoBean fullLoad = eProtectBeanList.get(i);
            ...
            hb_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(phone.equals("null") || phone.equals("")){
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "过期", StringConfig.OD_CWASTE + StringConfig.COMPANYNAME, StringConfig.TYPE_CWASTE, phone, phone2);
                    }
                }
            });
