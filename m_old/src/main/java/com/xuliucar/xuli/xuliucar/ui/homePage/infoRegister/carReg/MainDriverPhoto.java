 ...
 */
public class MainDriverPhoto extends BaseFragment implements View.OnClickListener{
    ...
    public void onClick(View views) {
        ...
        if (i == R.id.d_idcart_z) {
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.driverid1_url, -90);
                tag = 101;
            }
            ...
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.driverid2_url, -90);
                tag = 102;
            }
            ...
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.drivertmpid_url, -90);
            ...
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.drivertmpidb_url, -90);
            ...
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.drivercert_url, -90);
            ...
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.drivercertb_url, -90);
            ...
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.driverlic1_url, -90);
                tag = 107;
            }
            ...
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.driverlic3_url, -90);
                tag = 108;
            }
            ...
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.driverlic4_url, -90);
                tag = 109;
            }
            ...
            if (App.from.equals("")) {
                ...
                showOriginalPic(UrlConfig.driversafe_url, -90);
                tag = 110;
            }
