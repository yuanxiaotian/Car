...
package com.xuliucar.xuli.xuliucar.cropper.cropwindow;
...
import com.xuliucar.xuli.xuliucar.cropper.cropwindow.edge.Edge;
import com.xuliucar.xuli.xuliucar.cropper.cropwindow.handle.Handle;
import com.xuliucar.xuli.xuliucar.cropper.util.AspectRatioUtil;
import com.xuliucar.xuli.xuliucar.cropper.util.HandleUtil;
import com.xuliucar.xuli.xuliucar.cropper.util.PaintUtil;
...
public class CropOverlayView extends View {
    ...
    private void initCropWindow(Rect bitmapRect) {
        ...
        if (mFixAspectRatio) {
            ...
            final float horizontalPadding = 0.001f * bitmapRect.width();
            final float verticalPadding = 0.0001f * bitmapRect.height();
