...
public class DoDriverLicenseS extends BaseActivity implements SearchView.SearchViewListener {
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(DoDriverLicenseS.this, autoCompleteData);
        } else {
