package com.xuliucar.xuli.xuliucar.widget.tagView;
...
public class FlowTagLayout extends ViewGroup {
                    ...
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        ...
                        if (mCheckedTagArray.get(j)) {
                            ...
                            if (mOnTagSelectListener != null) {
                                mOnTagSelectListener.onItemSelect(FlowTagLayout.this, new ArrayList<Integer>(),j);
                            }
                            return;
                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(FlowTagLayout.this, Arrays.asList(j),j);
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        if (mCheckedTagArray.get(j)) {
                            mCheckedTagArray.put(j, false);
                        ...
                        if (mOnTagSelectListener != null) {
                            ...
                            mOnTagSelectListener.onItemSelect(FlowTagLayout.this, list,j);
                        }
                    }
                }
            });
     ...
     * @param j 角标
     */
    public void updataSingle(int j){
        if (mCheckedTagArray.get(j)) {
            mCheckedTagArray.put(j, false);
    ...
    public void setOption(int i,Boolean b){
        mCheckedTagArray.put(i,b);
        getChildAt(i).setSelected(b);
    ...
    public void saveOption(int i){
        if (mCheckedTagArray.get(i)) {
            ...
            PreferencesUtils.putSharePre(getContext(),"customphone", String.valueOf(i),false);
        } else {

            PreferencesUtils.putSharePre(getContext(),"customphone", String.valueOf(i),true);
        }
