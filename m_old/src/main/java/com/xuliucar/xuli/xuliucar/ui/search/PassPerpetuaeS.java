...
import com.xuliucar.xuli.xuliucar.adapter.PerpetuaeAdapterO;
...
public class PassPerpetuaeS extends BaseActivity implements SearchView.SearchViewListener,AdapterView.OnItemClickListener{
    private PerpetuaeAdapterO resultAdapter;
    private ListView lvResults;
    private List<PassPerPetaueBean.DataBean.InfoBean> mInfoBeanList;
    private List<PassPerPetaueBean.DataBean.InfoBean> resultData;
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(PassPerpetuaeS.this,autoCompleteData);
        } else {
    ...
    private void getResultData(String text) {
        ...
        if (resultAdapter == null) {
            resultAdapter = new PerpetuaeAdapterO(this, resultData);
        } else {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        PassPerPetaueBean.DataBean.InfoBean commentBean = resultData.get(i);
        Intent intent = new Intent(view.getContext(), CarDetail.class);
        Bundle bundle = new Bundle();
        bundle.putSerializable("passperpetuaeData", commentBean);
        bundle.putString("pageName", "passperpetuae");
