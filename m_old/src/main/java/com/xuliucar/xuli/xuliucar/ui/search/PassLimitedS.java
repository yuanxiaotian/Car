...
public class PassLimitedS extends BaseActivity implements SearchView.SearchViewListener,AdapterView.OnItemClickListener{
    private LimitedAdapterO resultAdapter;
    private ListView lvResults;
    private List<LimitedBean.DataBean.InfoBean> commentBeanList;
    private List<LimitedBean.DataBean.InfoBean> resultData;
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(PassLimitedS.this,autoCompleteData);
        } else {
    ...
    private void getResultData(String text) {
        ...
        if (resultAdapter == null) {
            resultAdapter = new LimitedAdapterO(this, resultData);
        } else {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        LimitedBean.DataBean.InfoBean commentBean = resultData.get(i);
