...
public class DoLimitedS extends BaseActivity implements SearchView.SearchViewListener,AdapterView.OnItemClickListener{
    private LimitedAdapter resultAdapter;
    private ListView lvResults;
    private List<LimitedBean.DataBean.InfoBean> mInfoBeanList;
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(DoLimitedS.this,autoCompleteData);
        } else {
    ...
    private void getResultData(String text) {
        ...
        if (resultAdapter == null) {
            resultAdapter = new LimitedAdapter(this, resultData);
        } else {
