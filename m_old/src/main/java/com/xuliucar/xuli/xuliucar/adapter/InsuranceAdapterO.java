 ...
 *
 */
public class InsuranceAdapterO extends BaseAdapter {
    ...
    public InsuranceAdapterO(Context context, List<InSuranceBean.DataBean.InfoBean> commonBeanList) {
        this.context = context;
        this.commonBeanList = commonBeanList;
        phoeList = new ArrayList<>();
        idList = new ArrayList<>();
    }
    public InsuranceAdapterO(Context context, List<InSuranceBean.DataBean.InfoBean> commonBeanList, int isdisplay){
        this.context = context;
        this.commonBeanList = commonBeanList;
    ...
    public InsuranceAdapterO(Context context, List<InSuranceBean.DataBean.InfoBean> commonBeanList, int isdisplay, OnSelectedItemChanged listener){
        this.context = context;
        this.commonBeanList = commonBeanList;
        this.isdisplay = isdisplay;
        map = new HashMap<>();
            ...
            bx_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if(rphone.equals("") && rphone2.equals("")){
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "过期", "尊敬的车主，您好。您的"+type+"已到期,请尽快与车队联系,谢谢。"+ StringConfig.COMPANYNAME, StringConfig.TYPE_INSURE, rphone, rphone2);
                    }
                }
            });
            ...
            bx_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(phone.equals("null") || phone.equals("")){
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "过期", "尊敬的车主，您好。您的"+type+"已到期,请尽快与车队联系,谢谢。"+ StringConfig.COMPANYNAME, StringConfig.TYPE_INSURE, phone, phone2);
                    }
                }
            });
