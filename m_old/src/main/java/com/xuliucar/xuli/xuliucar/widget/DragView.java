...
/**
 * Created by skyward on 2016/9/21.
 *
 */
public class DragView extends RelativeLayout implements View.OnClickListener,View.OnLongClickListener{
    ...
    protected void onFinishInflate() {
        ...
        fgView.setOnLongClickListener(this);
    ...
    public boolean onLongClick(View view) {
        mDragStateListener.LongViewClick(DragView.this , view);
        return true;
    }
    ...
    public interface DragStateListener{
        ...
        void LongViewClick(DragView dragView,View v);
    }
