...
public class DoTrusteeshipS extends BaseActivity implements SearchView.SearchViewListener{
    private TrusteeshipAdapter resultAdapter;
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(DoTrusteeshipS.this,autoCompleteData);
        } else {
    ...
    private void getResultData(String text) {
        ...
        if (resultAdapter == null) {
            resultAdapter = new TrusteeshipAdapter(this, resultData);
        } else {
