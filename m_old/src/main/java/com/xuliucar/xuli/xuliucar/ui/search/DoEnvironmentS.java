...
public class DoEnvironmentS extends BaseActivity implements SearchView.SearchViewListener, AdapterView.OnItemClickListener {
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(DoEnvironmentS.this, autoCompleteData);
        } else {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        EnvironmentBean.DataBean.InfoBean eProtectBean = resultData.get(i);
