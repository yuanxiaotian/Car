 ...
 * email
 */
public class YearRoadTAdapter extends BaseAdapter {
    ...
    public YearRoadTAdapter(Context context, List<YearRoadTBean.DataBean.InfoBean> roadeBeanList) {
    ...
    public YearRoadTAdapter(Context context, List<YearRoadTBean.DataBean.InfoBean> roadeBeanList, int isdisplay) {
        this.context = context;
        this.roadeBeanList = roadeBeanList;
    ...
    public YearRoadTAdapter(Context context, List<YearRoadTBean.DataBean.InfoBean> roadeBeanList, int isdisplay, OnSelectedItemChanged listener) {
        this.context = context;
        this.roadeBeanList = roadeBeanList;
        this.isdisplay = isdisplay;
        map = new HashMap<>();
            ...
            rr_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (rphone.equals("") && rphone2.equals("")) {
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "临期", StringConfig.ODT_TPCHK + StringConfig.COMPANYNAME, StringConfig.TYPE_TPCHK, rphone, rphone2);
                    }
            ...
            rr_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(phone.equals("null") || phone.equals("")){
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "临期", StringConfig.ODT_TPCHK + StringConfig.COMPANYNAME, StringConfig.TYPE_TPCHK, phone, phone2);
                    }
                }
            });
