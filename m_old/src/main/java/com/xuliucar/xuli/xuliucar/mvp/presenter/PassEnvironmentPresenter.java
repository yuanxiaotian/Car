...
import com.xuliucar.xuli.xuliucar.mvp.model.PassEnvironmentModel;
...
public class PassEnvironmentPresenter extends BasePresenterImpl implements CallBackListener<EnvironmentBean> {
    private PassEnvironmentModel mModel;
    private EnvironmentView mView;
    private Handler mHandler;
    private Gson mGson = new Gson();

    public PassEnvironmentPresenter(EnvironmentView view) {
        mView = view;
        mModel = new PassEnvironmentModel(this);
    }
    ...
    public void OnSuccess(EnvironmentBean bean) {
        if(bean.isSuccess()){
            App.mCache.put(CacheName.PASSENVIRONMENT,mGson.toJson(bean));
