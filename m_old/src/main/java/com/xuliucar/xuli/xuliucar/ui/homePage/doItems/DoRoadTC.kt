...
import com.xuliucar.xuli.xuliucar.mvp.presenter.DoRoadTCPresenter
import com.xuliucar.xuli.xuliucar.mvp.view.DoRoadTCView
import com.xuliucar.xuli.xuliucar.ui.homePage.allCar.CarDetail
import com.xuliucar.xuli.xuliucar.ui.search.DoRoadTCS
import com.xuliucar.xuli.xuliucar.utils.Pull
import com.xuliucar.xuli.xuliucar.utils.ToastUtil
import java.util.*

class DoRoadTC : BaseActivity(), AdapterView.OnItemClickListener, View.OnClickListener, DoRoadTCView {
    ...
    private var adapter: DoRoadTCAdapter? = null
    private var starts = 10
    private var ends = 10
    private val size = 10
    private var msg: String? = "1"
    private var mInfoBeanList: MutableList<DoRoadTCBean.DataBean.InfoBean>? = null
    private var mPresenter: DoRoadTCPresenter? = null
    ...
    override fun initContentView(savedInstanceState: Bundle) {
        ...
        mPresenter = DoRoadTCPresenter(this)
    }
...
//        matter_refreshLayout!!.beginRefreshing()
    ...
    override fun setListener() {
        ...
        mTo_search!!.setOnClickListener {
            val intent = Intent(this@DoRoadTC, DoRoadTCS::class.java)
    ...
    private fun initData(index: Int) {
        when (index) {
            0 -> {
                adapter = DoRoadTCAdapter(this@DoRoadTC, mInfoBeanList, 0)
                matter_listView!!.adapter = adapter
            }
            1 -> {
                adapter = DoRoadTCAdapter(this@DoRoadTC, mInfoBeanList!!, 1, DoRoadTCAdapter.OnSelectedItemChanged { })
                matter_listView!!.adapter = adapter
            }
        }
    }
...
//    }
    ...
    override fun onItemClick(adapterView: AdapterView<*>, view: View, i: Int, l: Long) {
        ...
        val bundle = Bundle()
        bundle.putSerializable("doroadtcData", commonBean)
...
//            } else {
//                PhoneMessage.selectSendStyle(this@DoRoadTC, phoeList, idList, "车主", "临期", StringConfig.ODT_TP + StringConfig.COMPANYNAME, StringConfig.TYPE_TP)
//            }
//
//        }
    }

    override fun startLoad(been: MutableList<DoRoadTCBean.DataBean.InfoBean>, size: Int) {
//        this.length = size
//        Handler().postDelayed({
...
//        }, 200)
    ...
    override fun loadMore(been: MutableList<DoRoadTCBean.DataBean.InfoBean>, size: Int) {
//        Handler().postDelayed({
//            mInfoBeanList!!.addAll(been)
//            adapter!!.notifyDataSetChanged()
...
//        }, 200)
    ...
    override fun loadAll(been: MutableList<DoRoadTCBean.DataBean.InfoBean>) {
        mInfoBeanList!!.addAll(been)
        adapter!!.notifyDataSetChanged()
    }
