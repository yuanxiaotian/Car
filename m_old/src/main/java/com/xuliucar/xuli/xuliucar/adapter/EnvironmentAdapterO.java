 ...
 * email
 */
public class EnvironmentAdapterO extends BaseAdapter {
    ...
    public EnvironmentAdapterO(Context context, List<EnvironmentBean.DataBean.InfoBean> eProtectBeanList) {
    ...
    public EnvironmentAdapterO(Context context, List<EnvironmentBean.DataBean.InfoBean> eProtectBeanList, int isdisplay) {
        this.context = context;
        this.eProtectBeanList = eProtectBeanList;
    ...
    public EnvironmentAdapterO(Context context, List<EnvironmentBean.DataBean.InfoBean> eProtectBeanList, int isdisplay, OnSelectedItemChanged listener) {
        this.context = context;
        this.eProtectBeanList = eProtectBeanList;
        this.isdisplay = isdisplay;
        map = new HashMap<>();
            ...
            hb_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (rphone.equals("") && rphone2.equals("")) {
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "过期", StringConfig.OD_EPM + StringConfig.COMPANYNAME, StringConfig.TYPE_EPM, rphone, rphone2);
                    }
            ...
            hb_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(phone.equals("null") || phone.equals("")){
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "过期", StringConfig.OD_EPM + StringConfig.COMPANYNAME, StringConfig.TYPE_EPM, phone, phone2);
                    }
                }
            });
