...
public class DriverLicenseAdapter extends BaseAdapter {
    ...
    public DriverLicenseAdapter(Context context, List<DriverLicenseBean.DataBean.InfoBean> commonBeanList) {
    ...
    public DriverLicenseAdapter(Context context, List<DriverLicenseBean.DataBean.InfoBean> commonBeanList, int isdisplay) {
        this.context = context;
        this.commonBeanList = commonBeanList;
    ...
    public DriverLicenseAdapter(Context context, List<DriverLicenseBean.DataBean.InfoBean> commonBeanList, int isdisplay, OnSelectedItemChanged listener) {
        this.context = context;
        this.commonBeanList = commonBeanList;
        this.isdisplay = isdisplay;
        map = new HashMap<>();
            ...
            dod_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (rphone.equals("") && rphone2.equals("")) {
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "司机", "临期", StringConfig.ODT_DRIVERLIC + StringConfig.COMPANYNAME, StringConfig.TYPE_DRIVERLIC, rphone, rphone2);
                    }
                }
            });
            ...
            dod_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(phone.equals("null") || phone.equals("")){
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "司机", "临期", StringConfig.ODT_DRIVERLIC + StringConfig.COMPANYNAME, StringConfig.TYPE_DRIVERLIC, phone, phone2);
                    }
                }
            });
