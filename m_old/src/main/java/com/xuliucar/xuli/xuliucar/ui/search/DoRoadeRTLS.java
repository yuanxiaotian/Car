...
public class DoRoadeRTLS extends BaseActivity implements SearchView.SearchViewListener {
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(DoRoadeRTLS.this, autoCompleteData);
        } else {
