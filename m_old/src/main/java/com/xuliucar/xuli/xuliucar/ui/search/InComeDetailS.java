...
public class InComeDetailS extends BaseActivity implements SearchView.SearchViewListener{

    private InComeAdapter resultAdapter;
    private ListView lvResults;
    private  List<InComeBean.DataBean> mDataBeanList;
    private List<InComeBean.DataBean> resultData;
    ...
    private void getData() {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                InComeBean inComeBean = mGson.fromJson(App.mCache.getAsJSONObject(CacheName.INCOMEDETAIL).toString(),InComeBean.class);
                int size = inComeBean.getData().size();
                mDataBeanList.addAll(inComeBean.getData());
                for (int i = 0; i <size; i++) {
                    allData.add(inComeBean.getData().get(i).getItem());
                }
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(InComeDetailS.this,autoCompleteData);
        } else {
    ...
    private void getResultData(String text) {
        ...
        if (resultAdapter == null) {
            resultAdapter = new InComeAdapter(this, resultData);
        } else {
