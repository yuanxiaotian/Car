...
public class DoYearTicketS extends BaseActivity implements SearchView.SearchViewListener,AdapterView.OnItemClickListener{
    private YearTickAdapter resultAdapter;
    private ListView lvResults;
    private List<YearTicketBean.DataBean.InfoBean> mInfoBeanList;
    private List<YearTicketBean.DataBean.InfoBean> resultData;
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(DoYearTicketS.this,autoCompleteData);
        } else {
    ...
    private void getResultData(String text) {
        ...
        if (resultAdapter == null) {
            resultAdapter = new YearTickAdapter(this, resultData);
        } else {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        YearTicketBean.DataBean.InfoBean commentBean = resultData.get(i);
