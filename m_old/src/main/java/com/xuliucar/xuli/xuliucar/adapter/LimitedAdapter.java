...
public class LimitedAdapter extends BaseAdapter {
    ...
    public LimitedAdapter(Context context, List<LimitedBean.DataBean.InfoBean> commentBeanList) {
    ...
    public LimitedAdapter(Context context, List<LimitedBean.DataBean.InfoBean> commentBeanList, int isdisplay) {
        this.context = context;
        this.commentBeanList = commentBeanList;
    ...
    public LimitedAdapter(Context context, List<LimitedBean.DataBean.InfoBean> commentBeanList, int isdisplay, OnSelectedItemChanged listener) {
        this.context = context;
        this.commentBeanList = commentBeanList;
        this.isdisplay = isdisplay;
        map = new HashMap<>();
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        TextView ns_plates = holder.getView(R.id.ns_plates);
        TextView ns_phone = holder.getView(R.id.ns_phone);
        TextView ns_chktime = holder.getView(R.id.ns_chktime);
        ...
        if (isdisplay == 0) {
            final LimitedBean.DataBean.InfoBean commonBean = commentBeanList.get(i);

            ns_plates.setText(commonBean.getPlates());
            ns_phone.setText(commonBean.getRphone());
            ns_chktime.setText(commonBean.getChktime());
            ...
            ns_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (rphone.equals("") && rphone2.equals("")) {
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "临期", StringConfig.ODT_YEARCHK + StringConfig.COMPANYNAME, StringConfig.TYPE_YEARCHK, rphone, rphone2);
                    }
            ...
            ns_plates.setText(fullLoad.getPlates());
            ns_phone.setText(fullLoad.getRphone());
            ns_chktime.setText(fullLoad.getChktime());
            phoeList.add(fullLoad.getRphone());
            ...
            ns_msg_layout.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(phone.equals("null") || phone.equals("")){
                        ...
                        PhoneMessage.selectSendStyle(context, idList, "车主", "临期", StringConfig.ODT_YEARCHK + StringConfig.COMPANYNAME, StringConfig.TYPE_YEARCHK, fullLoad.getRphone(), fullLoad.getRphone2());
                    }
                }
            });
