...
public class DoConstructionWasteS extends BaseActivity implements SearchView.SearchViewListener,AdapterView.OnItemClickListener{
    private ConstructionWastAdapter resultAdapter;
    private ListView lvResults;
    private List<ConstructionWasteBean.DataBean.InfoBean> mInfoBeanList;
    private List<ConstructionWasteBean.DataBean.InfoBean> resultData;
    ...
    private void getData() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                ConstructionWasteBean bean = mGson.fromJson(App.mCache.getAsJSONObject(CacheName.DOCONSTRUCTIONWASTE).toString(),ConstructionWasteBean.class);
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(DoConstructionWasteS.this,autoCompleteData);
        } else {
    ...
    private void getResultData(String text) {
        ...
        if (resultAdapter == null) {
            resultAdapter = new ConstructionWastAdapter(this, resultData);
        } else {
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ConstructionWasteBean.DataBean.InfoBean bean = resultData.get(i);
