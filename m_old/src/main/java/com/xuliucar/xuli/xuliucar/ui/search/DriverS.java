...
public class DriverS extends BaseActivity implements SearchView.SearchViewListener,AdapterView.OnItemClickListener{
    private static final String URL="http://www.gzxlxx.com:8866/index.php/Home/App/user_list?utype=driver";
                        ...
                        try {
                            ...
                            if(success.equals("true")){
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    String drivername = object1.getString("drivername");
                                    String search = drivername + "  "+ phone;
                                    contactsBeanList.add(new ContactsBean(id,drivername,phone,phone2,search));
                                ...
                                if (msg.equals("already logout")) {
                                    ...
                                    Intent intent = new Intent(DriverS.this,Login.class);
                                    startActivity(intent);
                                }
                            }
                            String msg = object.getString("message");
                            if (msg.equals("已登出,或在其它设备上登陆!")) {
                                ...
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                                        Intent i = new Intent(DriverS.this, Login.class);
    ...
    private void getAutoCompleteData(String text) {
        ...
        if (autoCompleteAdapter == null) {
            autoCompleteAdapter = new SearchAdapter(DriverS.this,autoCompleteData);
        } else {
...
//        Intent intent = new Intent(DriverS.this,DriverDetail.class);
