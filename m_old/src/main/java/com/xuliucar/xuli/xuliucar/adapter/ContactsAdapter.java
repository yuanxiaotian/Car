 ...
 *
 */
public class ContactsAdapter extends CommonAdapter<ContactsBean> implements SectionIndexer {

    private final int[] imageId = {R.drawable.juxing, R.drawable.juxing_16, R.drawable.juxing_55, R.drawable.juxing_95};
    private Dialog dialog;
    public ContactsAdapter(Context context, List<ContactsBean> contactsBeanList) {
        ...
        contacts_msg_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(phone.equals("") && phone2.equals("")){
                    ...
                    PhoneMessage.selectSendStyle(mContext, phone2);
                }else {
            ...
            public void onClick(View view) {
                if(phone.equals("") && phone2.equals("")){
                    ...
                    car_owner_phone_layout2.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            PhoneMessage.CallPhone(mContext,phone2);
                            dialog.dismiss();
                        }
                    });
                }
